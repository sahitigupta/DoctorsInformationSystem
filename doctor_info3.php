...
<div class="main">
  <div class="header_resize">
    <div class="header">
      ...
      <div class="clr"></div>
      <div class="menu"> 
		<a href="#"><img src="images/rss_1.gif" alt="picture" width="18" height="18" border="0" /></a> 
		<a href="#"><img src="images/rss_2.gif" alt="picture" width="18" height="18" border="0" /></a> 
...
?>
		...
		$sql1=mysql_query("SELECT * FROM doctor d, location l WHERE d.lid = l.lid AND Fname='$Fname' ")or die("Error1");
		...
		echo " <td  bgcolor='#CCCCFF'> <label> Experience </label></td> <td bgcolor='#CCFFFF'>$Exp  </td></tr>";
		...
		$sql7=mysql_query("Select * from prefer where id='$id' ") or die("error4");	
