  ...
  <div class="back_ground">
    ...
    <div class="body">
      <div class="body_resize">
        <h3>Hospital's search</h3>
        <p>&nbsp;</p>
        <form action="" method="post" >
          <table >
            <tr>
              <th> Search Hospital By </th>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$select=$_POST['op'];
	 if($select=='Location')
	{
		echo "<form action='hospital_info2.php' method='post' >";
		echo "<table> <tr><td> ";
		...
		elseif($select=='Name')
		{
			echo "<form action='hospital_info1.php' method='post' >";
					echo "<table><tr><td> Select Hospital Name </td><td> <select name='Hid'>  ";
					$sql=mysql_query("select * from hospital") or die ("nil");
