...
?>
		...
		$sql1=mysqli_query($conn,"SELECT * FROM doctor d, location l WHERE d.loc_id = l.loc_id AND city = '$city'  and country='$country' and state='$state'")or die("Error1");
		...
		echo "<tr><td  bgcolor='#CCCCFF' colspan='2' align='center'> <label> Hospital Name </label></td> <td bgcolor='#CCFFFF' colspan='2' align='center'>$hosp_name</td></tr>";	
